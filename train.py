...
def train():
    ...
    for epoch in tqdm(range(num_epochs)):
        ...
        for batch_idx, (inputs, masks) in tqdm(enumerate(train_loader)):
            ...
            if batch_idx % 25 == 0:
                ...
                with open(os.path.join("./log",start_time,"full_loss_realtime.txt"), "a") as f_intime:
    ...
    print(f"VISUALIZE EVALUATION RESULT")    # visualize_eval(start_time, eval_ids, eval_score)
    visualize(start_time)
    print(f"...Figure Saved to /curves/{start_time}/train-eval.png.")
